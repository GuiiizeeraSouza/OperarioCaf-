...
export default function Curiosidades() {
    return (
        <div className="ContainerCuriosidades" id="ContainerCuriosidades">
            <motion.div className="TextCuriosidadesLeft"
            ...
            <div className="FlechasCuriosidadesLeft">
                <motion.section className="Flecha1"
                    initial={{ opacity: 0, x: 50 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, top: -100 }}
                ...
                <motion.section className="Flecha2"
                    initial={{ opacity: 0, x: 50 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, top: -100 }}
                    transition={{ duration: 0.5 }}>
                ...
                <motion.section className="Flecha3"
                    initial={{ opacity: 0, x: 50 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, top: -100 }}
            ...
            <motion.div className="ImagemCopoOperario"
            ...
            <div className="FlechasCuriosidadesRigth">
                <motion.section className="Flecha4"
                 initial={{ opacity: 0, x: -50 }}
                 whileInView={{ opacity: 1, x: 0 }}
                 exit={{ opacity: 0, top: -100 }}
                 transition={{ duration: 0.2 }}
                ...
                <motion.section className="Flecha5"
                 initial={{ opacity: 0, x: -50 }}
                 whileInView={{ opacity: 1, x: 0 }}
                 exit={{ opacity: 0, top: -100 }}
                 transition={{ duration: 0.5 }}
                ...
                <motion.section className="Flecha6"
                 initial={{ opacity: 0, x: -50 }}
                 whileInView={{ opacity: 1, x: 0 }}
                 exit={{ opacity: 0, top: -100 }}
                 transition={{ duration: 0.9 }}
            ...
            <motion.div className="TextCuriosidadesRigth"
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, top: -100 }}
                transition={{ duration: 0.9 }}
